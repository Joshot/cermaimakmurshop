<div class="bg-white ">
    ...
    <!-- Breadcrumbs -->
    <nav class="bg-gray-100 py-4 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-[85rem] mx-auto">
            <ol class="list-reset flex text-gray-700 dark:text-gray-400">
                <li>
                    <a href="/" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Home</a>
                </li>
                <li class="mx-2">
                    <svg class="w-4 h-4 inline-block text-gray-500 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9l6 6 6-6" />
                    </svg>
                </li>
                <li>
                    <a href="/products" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Products</a>
                </li>
                <li class="mx-2">
                    <svg class="w-4 h-4 inline-block text-gray-500 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9l6 6 6-6" />
